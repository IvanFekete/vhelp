...
var mapOptions = {
zoom: 6,
center: new google.maps.LatLng(48.383022, 31.1828699),
panControl: true,
panControlOptions: {
...
if(userZip){
accessURL = "http://search.ams.usda.gov/farmersmarkets/v1/data.svc.." + userZip;
} else {
accessURL = "http://search.ams.usda.gov/farmersmarkets/v1/data.svc.." + userCords.latitude + "&lng=" + userCords.longitude;
}
...
url: "http://search.ams.usda.gov/farmersmarkets/v1/data.svc.." + v,
dataType: 'jsonp',
success: function (data) {
